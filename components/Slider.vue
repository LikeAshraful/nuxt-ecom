    ...
    <section class="intro-section">
        <div class="swiper-container swiper-theme nav-inner pg-inner swiper-nav-lg animation-slider pg-xxl-hide nav-xxl-show nav-hide">
            <div class="swiper-wrapper">
                <div class="swiper-slide banner banner-fixed intro-slide intro-slide1" :style="{ backgroundImage: 'url(' + require('@/assets/images/demos/demo1/sliders/slide-1.jpg') + ')' }">
                    <div class="container">
                ...
                <div class="swiper-slide banner banner-fixed intro-slide intro-slide2" :style="{ backgroundImage: 'url(' + require('@/assets/images/demos/demo1/sliders/slide-2.jpg') + ')' }">
                    <div class="container">
                ...
                <div class="swiper-slide banner banner-fixed intro-slide intro-slide3" :style="{ backgroundImage: 'url(' + require('@/assets/images/demos/demo1/sliders/slide-3.jpg') + ')' }">
                    <div class="container">
                        <figure class="slide-image skrollable slide-animate" data-animation-options="{
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            // init Swiper:
            const swiper = new Swiper('.animation-slider', {
                // Optional parameters
