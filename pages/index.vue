<template>    
  <main class="main">
    ...
    <div class="container">
        <div class="swiper-container icon-box-wrapper br-sm mt-6 mb-6" data-swiper-options="{
            'slidesPerView': 1,
            'loop': false,
            'breakpoints': {
                '576': {
    ...
    <div class="container">
        <h2 class="title justify-content-center ls-normal mb-4 mt-10 pt-1 animate__animated">Popular Departments
        </h2>
        <div class="tab tab-nav-boxed tab-nav-outline animate__animated">
        ...
        <!-- End of Tab -->
        <div class="tab-content product-wrapper animate__animated">
        ...
        <div class="row category-cosmetic-lifestyle animate__animated mb-5">
            <div class="col-md-6 mb-4">
        ...
        <div class="product-wrapper-1 animate__animated mb-5">
        ...
        <div class="product-wrapper-1 animate__animated mb-8">
            <div class="title-link-wrapper pb-1 mb-4">
        ...
        <div class="banner banner-fashion animate__animated br-sm mb-9" style="background-image: url(assets/images/demos/demo1/banners/4.jpg);
        ...
        <div class="product-wrapper-1 animate__animated mb-7">
            <div class="title-link-wrapper pb-1 mb-4">
        ...
        <h2 class="title title-underline mb-4 ls-normal animate__animated">Our Clients</h2>
        <div class="swiper-container swiper-theme brands-wrapper mb-9 animate__animated" data-swiper-options="{
            'spaceBetween': 0,
            'slidesPerView': 2,
            'breakpoints': {
                '576': {
        ...
        <div class="post-wrapper animate__animated mb-4">
            <div class="title-link-wrapper pb-1 mb-4">
        ...
        <h2 class="title title-underline mb-4 ls-normal animate__animated">Your Recent Views</h2>
        <div class="swiper-container swiper-theme shadow-swiper animate__animated pb-4 mb-8" data-swiper-options="{
            'spaceBetween': 20,
            'slidesPerView': 2,
            'breakpoints': {
                '576': {
